...
echo "33 facts_0033.lf data Idealism, Private Language, and Replacing Classes"
...
read select
case $select in
0) $EDITOR ../FACTS2/facts_0000.lf;;
1) $EDITOR ../FACTS2/facts_0001.lf;;
2) $EDITOR ../FACTS2/facts_0002.lf;;
3) $EDITOR ../FACTS2/facts_0003.lf;;
4) $EDITOR ../FACTS2/facts_0004.lf;;
5) $EDITOR ../FACTS2/facts_0005.lf;;
6) $EDITOR ../FACTS2/facts_0006.lf;;
31) $EDITOR ../FACTS2/facts_0031.lf;;
33) $EDITOR ../FACTS2/facts_0033.lf;;
71) $EDITOR ../FACTS2/facts_0071.lf;;
81) $EDITOR ../FACTS2/facts_0081.lf;;
