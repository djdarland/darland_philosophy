...
listing(pl_external_synonym)?

listing(book)?

listing(philosopher)?

listing(a_philosopher)?

listing(article)?

listing(philosophical_quotation)?

%% listing(pl_external_synonym_simple_expanded)?

%% listing(pl_ambiguity_2)?

%% listing(quote_note)?

%% listing(actual_author)?

philosophical_quotation(Id_Number, Author, Article_Abbreviation, Book_Abbreviation, Pages, Quotation, Note1)?
;
;
;
;

article(Article_Abbreviation, Book_Abbreviation, Author_Abbreviation, Article_Title, Article_Year, Notes_Article)?
;
;
;
;

book(Book_Abbreviation, Author_Book_Abbrev, Book_Title, Book_Year, Notes_Book)? 
;

philosopher(Author_Book_Abbrev, Author_Book)?
;
;
;
;
