...
$\pmast 3 \pmcdot 47 \pmthm  C    K    C   p   r    C   q   s     C    K   p   q     K   r   s  $
...
$\pmast 4 \pmcdot 41 \pmthm  E    A   p     K   q   r     K    A   p   q    A   p   r $
...
$\pmast 4 \pmcdot 44 \pmthm  E   p     A   p     K   p   q $
...
$\pmast 5 \pmcdot 33 \pmthm  E    K   p    C   q   r     C    K   p    K   p   q    r $
...
$\pmast 431 \pmcdot 54 \pmthm \pmdott p \pmand q \pmand r \pmand s \pmdott \pmimp \pmdott p \pmand s \pmandd r \pmand q $ 
 
 
 
$\pmast 431 \pmcdot 54 \pmthm  ((((  p ) \land ( q ) \land ( r ) \land ( s  )))) \pmimp ((((  p ) \land ( s )) \land (( r ) \land ( q  ))))$

$\pmast 431 \pmcdot 54 \pmthm  C    K    K    K   p   q   r   s     K    K   p   s    K   r   q   $
...
% $\pmast 5 \pmcdot 33 \pmthm  (((  pabc ) \land ( qdef \pmimp rghi  ))) \pmiff ((((  pabc )) \land (( pabc ) \land ( qdef  ))) \pmimp (((  rghi))))$

% $\pmast 5 \pmcdot 33 \pmthm  E    K   pabc    C   qdef   rghi     C    K   pabc    K   pabc   qdef    rghi $
...
% $\pmast 10 \pmcdot 35 \pmthm  E    K   \pmsome{x}   p   \pmpf{\psi}{x}     K   p   \pmsome{x}   \pmpf{\psi}{x}   $
...
% $\pmast 11 \pmcdot 551 \pmthm  E    K   \pmall{x}   \pmsome{y}   \pmpf{\psi}{x}   \pmpf{\phi}{[x,y]}     K   \pmpf{\psi}{x}   \pmsome{y}   \pmpf{\phi}{[x,y]}  $
