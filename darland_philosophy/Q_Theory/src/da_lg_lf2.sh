...
read select
case $select in
0) $EDITOR ../OUT2/append.out;;
1) $EDITOR ../OUT2/darland_0001.out;;
2) $EDITOR ../OUT2/darland_0002.out;;
3) $EDITOR ../OUT2/darland_0003.out;;
4) $EDITOR ../OUT2/darland_0004.out;;
5) $EDITOR ../OUT2/darland_0005.out;;
6) $EDITOR ../OUT2/darland_0006.out;;
7) $EDITOR ../OUT2/darland_0007.out;;
8) $EDITOR ../OUT2/darland_0008.out;;
9) $EDITOR ../OUT2/darland_0009.out;;
10) $EDITOR ../OUT2/darland_0010.out;;
