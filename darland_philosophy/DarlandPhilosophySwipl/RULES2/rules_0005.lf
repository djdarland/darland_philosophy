...
%%    There are two primitive sorts of molecular belief

%%    One in words

%%    believes_not_in_words(Subject, Time, Type, Arity,
%%		      [[Relation_Word_1,
%%		      A_Word_1,
%%		      B_Word_1,
%%		      C_Word_1, ...])
...
%%    And One in ideas
%%    believes_not_in_ideas(Subject, Time, Type, Arity,
%%		      [[Relation_Idea_1,
%%		      A_Idea_1,
%%		      B_Idea_1,
%%		      C_Idea_1, ...])
...
believes_nor_word_idea_object_L(Subject, Time, Type, Arity,
				Word_List,
				Idea_List,
				Object_List) :-
    %% list of list of word, object pairs
    all_nor_WIO_L(Subject, Time, Type, Arity,
				[],
				[],
				[],
				List_Word_List,
...
all_nor_WIO_L(Subject, Time, Type, Arity,
				[List_Word_List_In_Head | List_Word_List_In_Tail],
				[List_Idea_List_In_Head | List_Idea_List_In],
				[List_Object_List_In_Head | List_Object_List_In],
				Word_List,
				Idea_list,
				Object_list) :-
...
%			    TripleList),
    cond(length(List_Word_List_Tail) > 0,
	 (cond(length(List_Idea_List_Tail) =:= length(List_Word_List_Tail),
	       all_nor_WIO_L(Subject, Time, Type, Arity, List_Word_List_Tail, List_Idea_List_Tail)))).
