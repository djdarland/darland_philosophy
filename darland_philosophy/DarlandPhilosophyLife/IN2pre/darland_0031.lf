...
qqqq(understands_words, tom, now,
     [[denounced_word],
      [cicero_word],
      [catiline_word]])?
...
qqqq(understands_ideas, tom, now,
     [[tom_denounced_idea],
      [tom_cicero_idea],
      [tom_catiline_idea]])?
...
qqqq(understands_objects, tom, now,
     [[denounced],
      [cicero],
      [catiline]])?
...
qqqq(understands_words_ideas, tom, now,
...
qqqq(understands_words_objects, tom, now,
...
qqqq(understands_ideas_objects, tom, now,
...
qqqq(understands_words_ideas_objects, tom, now,
