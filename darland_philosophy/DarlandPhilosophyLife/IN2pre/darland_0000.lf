...
qqqq(rrss, tom, now, of_orations_word, of_orations)?

%% Next should be TRUE.

qqqq(rrss, tom, now, of_De_Senectute_word, of_De_Senectute)?
...
qqqq(rrrr, tom, now, cicero_word, tom_tully_idea)?
...
qqqq(rrrr, tom, now, tully_word, tom_cicero_idea)?

%% Next should be TRUE.

qqqq(rrss, tom, now, cicero_word, cicero)?

%% Next should be TRUE - There is no Tully separate from cicero, just idea

qqqq(rrss, tom, now, tully_word, cicero)?

%% Next should be TRUE.

qqqq(rrss, tom, now, catiline_word, catiline)?

%% Next should be TRUE.

qqqq(rrss, tom, now, denounced_word, denounced)?
...
qqqq(rrrr, quine, now, cicero_word, quine_tully_idea)?
...
qqqq(rrrr, quine, now, tully_word, quine_cicero_idea)?
...
qqqq(rrss, quine, now, cicero_word, cicero)?

%% Next should be TRUE.

qqqq(rrss, quine, now, of_orations_word, of_orations)?

%% Next should be TRUE.

qqqq(rrss, quine, now, of_De_Senectute_word, of_De_Senectute)?
