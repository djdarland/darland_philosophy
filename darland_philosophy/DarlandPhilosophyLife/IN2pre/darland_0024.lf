...
qqqq(believes_true_words, tom, now,
     [[denounced_word],
      [cicero_word],
      [catiline_word]])?
...
qqqq(believes_true_in_ideas, tom, now,
     [tom_denounced_idea,
      tom_cicero_idea,
      tom_catiline_idea])?
...
qqqq(believes_true_objects, tom, now,
     [[denounced],
      [cicero],
      [catiline]])?
...
qqqq(believes_true_words_ideas, tom, now,
...
qqqq(believes_true_words_objects, tom, now,
...
qqqq(believes_true_ideas_objects, tom, now,
...
qqqq(believes_true_words_ideas_objects, tom, now,
...
qqqq(believes_true_not_words, tom, now,
     [[denounced_word],
      [cicero_word],
      [catiline_word]])?
...
qqqq(believes_true_not_in_ideas, tom, now,
     [tom_denounced_idea,
      tom_cicero_idea,
      tom_catiline_idea])?
...
qqqq(believes_true_not_objects, tom, now,
     [[denounced],
      [cicero],
      [catiline]])?
...
qqqq(believes_true_not_words_ideas, tom, now,
     [[denounced_word, tom_denounced_idea],
      [cicero_word, tom_cicero_idea],
      [catiline_word, tom_catiline_idea]])?
...
qqqq(believes_true_not_words_objects, tom, now,
     [[denounced_word, denounced],
      [cicero_word, cicero],
      [catiline_word, catiline]])?
...
qqqq(believes_true_not_ideas_objects, tom, now,
     [[tom_denounced_idea, denounced],
      [tom_cicero_idea, cicero],
      [tom_catiline_idea, catiline]])?
...
qqqq(believes_true_not_words_ideas_objects, tom, now,
     [[denounced_word, tom_denounced_idea, denounced],
      [cicero_word, tom_cicero_idea, cicero],
      [catiline_word, tom_catiline_idea, catiline]])?
