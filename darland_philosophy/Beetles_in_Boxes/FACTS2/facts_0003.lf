...
%%
believes_ideas_synonymous( quine, quine_cicero_idea, quine_tully_idea).

believes_ideas_synonymous( quine, quine_of_De_Senectute_idea, quine_of_orations_idea).

believes_ideas_not_synonymous( tom, tom_of_De_Senectute_idea, tom_of_orations_idea).
...
believes_in_ideas( tom, now, [tom_human_idea, tom_tully_idea]).
...
believes_in_ideas( quine, now, [quine_denounced_idea,
				     quine_cicero_idea,
				     quine_catiline_idea]).
...
believes_not_in_ideas( dennis, now,
		      [martian_idea,
		      cicero_idea]).
